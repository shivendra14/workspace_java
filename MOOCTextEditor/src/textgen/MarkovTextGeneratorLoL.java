...
public class MarkovTextGeneratorLoL implements MarkovTextGenerator {
	...
	public void train(String sourceText)
	{
		...
		int i=0;
		int len=sourceWords.length;
		String beginningWord=starter;
		if (len>0)
		{
			if (starter.equals(""))
				beginningWord=sourceWords[0];
		...
		for(i=0;i<len;i++)
		{
			...
			if(i<len-1)
				starter=sourceWords[i+1];
			else
				starter=beginningWord;
			ListNode node=searchWordList(word);
			if (node==null)
			{
	...
	public String generateText(int numWords) {
		...
		while (numWords!=0)
		{
			...
			ListNode node=searchWordList(currentWord);
			if (node!=null)
	...
	private ListNode searchWordList(String word)
	{
		ListNode node=null;
		for (ListNode iterator:wordList)
		{
	...
	public static void main(String[] args)
	{
		...
		//MarkovTextGeneratorLoL gen = new MarkovTextGeneratorLoL(new Random((int)(Math.random()*100)));
